...
func apply_data(data: Dictionary) -> void:
	...
	_set_label_text(free_points_value, str(resolved.get("free_points", "")))
	_set_label_text(hint_text, str(resolved.get("hint", "")))
	_set_label_text(strength_value, str(resolved.get("strength", "")))
	_set_label_text(vitality_value, str(resolved.get("vitality", "")))
	_set_label_text(agility_value, str(resolved.get("agility", "")))
	_set_label_text(mind_value, str(resolved.get("mind", "")))
	_set_label_text(advice_text, str(resolved.get("advice", "")))
	_set_label_text(plan_text, str(resolved.get("plan", "")))
