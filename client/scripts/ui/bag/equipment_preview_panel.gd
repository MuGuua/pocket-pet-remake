...
@onready var _player_demo_sprite: AnimatedSprite2D = $PanelContainer/MarginContainer/VBoxContainer/HBoxContainer2/Control/HBoxContainer/Control/HBoxContainer/Player
## 中央展示区中用于占位的宠物演示节点；脚本会读取其位置和缩放作为真实形象锚点。
@onready var _pet_demo_sprite: AnimatedSprite2D = $PanelContainer/MarginContainer/VBoxContainer/HBoxContainer2/Control/HBoxContainer/Control/HBoxContainer/Pet
