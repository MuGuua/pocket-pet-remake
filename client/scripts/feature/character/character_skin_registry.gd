...
const UNIT_SKIN_RESOURCE_PATHS: Array[String] = [
    ...
    "res://resources/battle/unit_skins/宠物/嫩叶犬_001.tres",
    "res://resources/battle/unit_skins/宠物/潮汐狐_001.tres",
    "res://resources/battle/unit_skins/宠物/恶魔武士_001.tres",
...
static func _register_legacy_skin_aliases() -> void:
    ...
    _register_alias_if_missing("白色幻影_001", "白色幻影chj_830")
    _register_alias_if_missing("魅惑猫妖_001", "魅惑猫妖chj_834")
