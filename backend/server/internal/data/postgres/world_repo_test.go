...
func TestPortalFallbackPositionsKeepServerTopologyValid(t *testing.T) {
	tests := []struct {
		...
		{name: "东路到市场", fromSceneID: 2, toSceneID: 3, portalID: 2002, wantSpawnPos: world.Vec2i{X: 11, Y: 11}},
		...
		{name: "市场到学校", fromSceneID: 3, toSceneID: 5, portalID: 3003, wantSpawnPos: world.Vec2i{X: 11, Y: 3}},
		...
		{name: "东路到闪光镇传送区", fromSceneID: 2, toSceneID: 8, portalID: 2003, wantSpawnPos: world.Vec2i{X: 1, Y: 13}},
		...
		{name: "闪耀广场到商业区", fromSceneID: 9, toSceneID: 16, portalID: 9003, wantSpawnPos: world.Vec2i{X: 13, Y: 10}},
		...
		{name: "阿尔房间到宠物学校", fromSceneID: 14, toSceneID: 10, portalID: 14001, wantSpawnPos: world.Vec2i{X: 5, Y: 10}},
		{name: "闪耀广场到报名区", fromSceneID: 9, toSceneID: 17, portalID: 9006, wantSpawnPos: world.Vec2i{X: 1, Y: 7}},
		{name: "报名区到闪耀广场", fromSceneID: 17, toSceneID: 9, portalID: 17001, wantSpawnPos: world.Vec2i{X: 22, Y: 8}},
		...
		{name: "准备区到报名区", fromSceneID: 18, toSceneID: 17, portalID: 18001, wantSpawnPos: world.Vec2i{X: 9, Y: 7}},
		...
		{name: "灰烬梦境到办公区", fromSceneID: 12, toSceneID: 15, portalID: 12001, wantSpawnPos: world.Vec2i{X: 5, Y: 4}},
		{name: "办公区到翡翠梦境", fromSceneID: 15, toSceneID: 13, portalID: 15003, wantSpawnPos: world.Vec2i{X: 1, Y: 9}},
		{name: "翡翠梦境到办公区", fromSceneID: 13, toSceneID: 15, portalID: 13001, wantSpawnPos: world.Vec2i{X: 9, Y: 8}},
		{name: "闪光南路到家族会馆", fromSceneID: 20, toSceneID: 19, portalID: 20002, wantSpawnPos: world.Vec2i{X: 13, Y: 11}},
		...
		{name: "精灵大厅到海道", fromSceneID: 25, toSceneID: 26, portalID: 25001, wantSpawnPos: world.Vec2i{X: 10, Y: 9}},
