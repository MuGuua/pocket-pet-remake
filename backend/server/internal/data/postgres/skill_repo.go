...
const skillDefinitionInsertColumns = `
  ...
  is_skill_attack, is_basic_attack, energy_cost, allow_crit, ignore_defense, skill_mult, skill_crit_add, skill_hit_bonus,
...
SET skill_code = $2,
    ...
    defense_pct = $30,
    speed_pct = $31,
    target_current_hp_pct = $32,
    fixed_damage = $33,
    heal_pct = $34,
    fixed_heal = $35,
    armor_break_pct = $36,
    vulnerability_pct = $37,
    bleed_chance_pct = $38,
    bleed_rounds = $39,
    bleed_damage = $40,
    seal_chance_pct = $41,
    seal_power = $42,
    seal_rounds = $43,
    vulnerability_chance_pct = $44,
    vulnerability_rounds = $45,
    vulnerability_apply_pct = $46,
    armor_break_chance_pct = $47,
    armor_break_rounds = $48,
    slow_chance_pct = $49,
    slow_rounds = $50,
    slow_multiplier_pct = $51,
    crit_boost_rounds = $52,
    crit_boost_pct = $53,
    curse_chance_pct = $54,
    curse_rounds = $55,
    curse_damage = $56,
    curse_mana_pct = $57,
    control_chance_pct = $58,
    control_power = $59,
    control_rounds = $60,
    control_status_id = $61,
    passive_attr_key = $62,
...
func skillUpsertArgs(skillID uint32, input skill.AdminUpsertInput, status int64) []any {
	return []any{
		...
		input.SkillMult, input.SkillCritAdd, input.SkillHitBonus,
...
func scanSkillDefinitionRow(scanner interface {
	...
	err := scanner.Scan(
		...
		&row.skillMult, &row.skillCritAdd, &row.skillHitBonus,
...
func adminDetailFromRow(raw skillDefinitionRow) *skill.AdminDetail {
	detail := &skill.AdminDetail{
		...
		Formula: skill.AdminFormula{
			...
			SkillHitBonus:      uint32(raw.skillHitBonus),
		},
