...
var scenes = map[uint32]sceneData{
	...
	7: {spawnPos: world.Vec2i{X: 4, Y: 4}, entries: map[uint32]world.Vec2i{}, nearby: []world.Entity{}, exits: map[uint32]struct{}{2: {}}, portals: map[uint32]portalData{7001: {targetSceneID: 2, targetPos: world.Vec2i{X: 8, Y: 1}}}},
}
