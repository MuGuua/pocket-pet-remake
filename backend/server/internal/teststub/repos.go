...
var scenes = map[uint32]sceneData{
	...
	8:  {spawnPos: world.Vec2i{X: 4, Y: 6}, entries: map[uint32]world.Vec2i{2: {X: 2, Y: 12}, 9: {X: 6, Y: 9}}, nearby: []world.Entity{}, exits: map[uint32]struct{}{2: {}, 9: {}}, portals: map[uint32]portalData{8001: {targetSceneID: 2, targetPos: world.Vec2i{X: 9, Y: 5}}, 8002: {targetSceneID: 9, targetPos: world.Vec2i{X: 20, Y: 12}}}},
	...
	17: {spawnPos: world.Vec2i{X: 5, Y: 7}, entries: map[uint32]world.Vec2i{9: {X: 1, Y: 7}, 18: {X: 9, Y: 6}}, nearby: []world.Entity{}, exits: map[uint32]struct{}{9: {}, 18: {}}, portals: map[uint32]portalData{17001: {targetSceneID: 9, targetPos: world.Vec2i{X: 23, Y: 8}}, 17002: {targetSceneID: 18, targetPos: world.Vec2i{X: 2, Y: 7}}, 17003: {targetSceneID: 18, targetPos: world.Vec2i{X: 7, Y: 5}}}},
	18: {spawnPos: world.Vec2i{X: 5, Y: 7}, entries: map[uint32]world.Vec2i{17: {X: 2, Y: 7}}, nearby: []world.Entity{}, exits: map[uint32]struct{}{17: {}}, portals: map[uint32]portalData{18001: {targetSceneID: 17, targetPos: world.Vec2i{X: 9, Y: 6}}}},
