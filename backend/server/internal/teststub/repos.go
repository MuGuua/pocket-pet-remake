...
var scenes = map[uint32]sceneData{
	...
	9: {spawnPos: world.Vec2i{X: 14, Y: 8}, entries: map[uint32]world.Vec2i{8: {X: 20, Y: 12}}, nearby: []world.Entity{}, exits: map[uint32]struct{}{8: {}}, portals: map[uint32]portalData{9001: {targetSceneID: 8, targetPos: world.Vec2i{X: 6, Y: 9}}}},
}
